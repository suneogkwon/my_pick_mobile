...
/// Adds pattern-matching-related methods to [GameFirebaseModel].
extension GameFirebaseModelPatterns on GameFirebaseModel {
...
/// Adds pattern-matching-related methods to [GameItemFirebaseModel].
extension GameItemFirebaseModelPatterns on GameItemFirebaseModel {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
