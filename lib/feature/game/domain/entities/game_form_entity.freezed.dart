...
/// Adds pattern-matching-related methods to [GameFormEntity].
extension GameFormEntityPatterns on GameFormEntity {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _GameFormEntity value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _GameFormEntity() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _GameFormEntity value)  $default,){
final _that = this;
switch (_that) {
case _GameFormEntity():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _GameFormEntity value)?  $default,){
final _that = this;
switch (_that) {
case _GameFormEntity() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String? title,  String? description,  List<GameItemFormEntity>? items)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GameFormEntity() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.items);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String? title,  String? description,  List<GameItemFormEntity>? items)  $default,) {final _that = this;
switch (_that) {
case _GameFormEntity():
return $default(_that.id,_that.title,_that.description,_that.items);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String? title,  String? description,  List<GameItemFormEntity>? items)?  $default,) {final _that = this;
switch (_that) {
case _GameFormEntity() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.items);case _:
  return null;
...
/// Adds pattern-matching-related methods to [GameItemFormEntity].
extension GameItemFormEntityPatterns on GameItemFormEntity {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _GameItemFormEntity value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _GameItemFormEntity() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _GameItemFormEntity value)  $default,){
final _that = this;
switch (_that) {
case _GameItemFormEntity():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _GameItemFormEntity value)?  $default,){
final _that = this;
switch (_that) {
case _GameItemFormEntity() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  File? image,  String? description)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GameItemFormEntity() when $default != null:
return $default(_that.id,_that.image,_that.description);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  File? image,  String? description)  $default,) {final _that = this;
switch (_that) {
case _GameItemFormEntity():
return $default(_that.id,_that.image,_that.description);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  File? image,  String? description)?  $default,) {final _that = this;
switch (_that) {
case _GameItemFormEntity() when $default != null:
return $default(_that.id,_that.image,_that.description);case _:
  return null;
